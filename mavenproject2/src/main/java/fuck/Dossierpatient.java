...
public class Dossierpatient  implements java.io.Serializable {
    ...
    public Dossierpatient(BigDecimal numdos, Docteur docteur, String nomp, String prenomp, String sexe, String numas, Date datenaiss, Date datec, BigDecimal nbrconsultation, Set consultations) {
       this.numdos = numdos;
